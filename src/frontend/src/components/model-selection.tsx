...
export const modelMap: Record<ChatModel, Model> = {
  [ChatModel.GPT_3_5_TURBO]: {
    ...
    smallIcon: <Smile className="w-4 h-4 text-cyan-500" />,
    icon: <Smile className="w-5 h-5 text-cyan-500" />,
  },
  [ChatModel.GPT_4O]: {
    name: "GPT-4o",
    description: "OpenAI",
    value: ChatModel.GPT_4O,
    smallIcon: <PartyPopper className="w-4 h-4 text-pink-500" />,
  ...
  [ChatModel.LLAMA3]: {
    ...
    smallIcon: <PenIcon className="w-4 h-4 text-purple-500" />,
    icon: <PenIcon className="w-5 h-5 text-purple-500" />,
  },
  [ChatModel.GEMMA]: {
    name: "Gemma",
